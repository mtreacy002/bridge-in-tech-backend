                        ...
                        try:
                            if user_additional_info.is_organization_rep:
                                if organization["rep_id"] == user["id"]:
                                    readable_join_date = convert_timestamp_to_human_date(organization["join_date"], AUTH_COOKIE["timezone"].value)
                                    organization_item = {
                                        "id": organization["id"],
    ...
    try:
        if representative_additional_info.is_organization_rep:
            ...
            try:
                ...
                readable_join_date = convert_timestamp_to_human_date(result.join_date, AUTH_COOKIE["timezone"].value)
                return {
                    "id": result.id,
