    ...
    def create_program(organization_id, data):
        ...
        try:
            if representative_additional_info.is_organization_rep:
                ...
                timestamp_start_date = convert_human_date_to_timestamp(start_date, AUTH_COOKIE["timezone"].value)
                timestamp_end_date = convert_human_date_to_timestamp(end_date, AUTH_COOKIE["timezone"].value)
...
def get_program(program, organization, user):
    try:
        readable_start_date = convert_timestamp_to_human_date(program.start_date, AUTH_COOKIE["timezone"].value)
        readable_end_date = convert_timestamp_to_human_date(program.end_date, AUTH_COOKIE["timezone"].value)
        readable_creation_date = convert_timestamp_to_human_date(program.creation_date, AUTH_COOKIE["timezone"].value)
